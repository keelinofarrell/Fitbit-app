...
class FitbitsControllerTest < ActionController::TestCase
  ...
  test "should create fitbit" do
    assert_difference('Fitbit.count') do
      post :create, fitbit: { battery_life: @fitbit.battery_life, colour: @fitbit.colour, display: @fitbit.display, name: @fitbit.name, picture: @fitbit.picture }
    end
  ...
  test "should update fitbit" do
    patch :update, id: @fitbit, fitbit: { battery_life: @fitbit.battery_life, colour: @fitbit.colour, display: @fitbit.display, name: @fitbit.name, picture: @fitbit.picture }
    assert_redirected_to fitbit_path(assigns(:fitbit))
  end
